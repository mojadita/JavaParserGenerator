...
/**
 * This class allows to execute a compiled parser over a
 * {@link Iterable}{@code <}{@link Symbol}{@code <S>>}.
 * 
 * It allows to registration of listeners to events on reducing
 * rules, so those listeners can act upon the matching of parsing
 * tree structures.
 * 
...
public class CompiledGrammar<S extends Enum<S>>
    ...
    /**
     * This class represents a {@code CompiledGrammar}
     * {@link State}.
     * @author Luis Colorado {@code <lcu@basen.net>}
     */
    public class State {
        private final int id = m_nextId++;
        private final Map<S, Transition> m_nextMap = new EnumMap<S, Transition>( m_symbolClass );
        ...
        public class Transition {
            ...
            /**
             * Getter for the {@code List<Listener>} {@code listeners} attribute.
             * @return the {@code List<Listener>} value of the {@code listeners} attribute.
             */
         ...
         * @return the {@code Map<S,Transition>} value of the {@code nextMap} attribute.
         */
